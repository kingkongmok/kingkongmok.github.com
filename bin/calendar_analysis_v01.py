...
logName = ['/home/logs/smsmw/172.16.210.52/calendar/monitor.log.'+logTime,'/home/logs/smsmw/172.16.210.53/calendar/monitor.log.'+logTime,\
...
setDic = {'calendar:addLabel':'添加日历','calendar:updateLabel':'更新日历','calendar:deleteLabel':'删除日历',\
		  ...
		  'calendar:getLabels':'查询用户日历列表','calendar:listTopLabels':'查询前十个公共日历','calendar:getCalendarListView':'查询活动列表视图',\
          ...
          'calendar:searchPublicLabel':'搜索公共日历','calendar:getPublishedLabelByOper':'得到公共日历详情','api:publishLabelByOper':'发布公共日历',\
          'api:updatePublishedLabelByOper':'修改公共日历','calendar:copyCalendar':'复制活动','calendar:getCalendarList':'酷版时间轴接口',\
