...
<<<<<<< HEAD
CURL="/usr/bin/curl --socks5-hostname 127.0.0.1:7073"
=======
CURL="/usr/bin/curl --socks5-hostname 127.0.0.1:7074"
# CURL="/usr/bin/curl"
>>>>>>> 7067907cc8db05abdd5dc7ae51b73446c1e3a6ee
FailureMode=0
ERRORMAKR=0
...
getURL()
{
    ...
    # get URL from $1
    #CURL="/usr/bin/curl --socks5-hostname 127.0.0.1:7074"
    MESSAGE=`$CURL --socks5-hostname 127.0.0.1:7074  -k -H "$CURL_HEADER" -s $DOWNLOADLINE`
