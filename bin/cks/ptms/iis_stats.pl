...
if ( $opt_s or $opt_d ) {
    ...
    $LogPath = "/home/kk/logs/172.16.45.$opt_s/LogFiles/W3SVC1/u_ex$logDate.log";
    $now = $now - ($opt_d?$opt_d:0)*24*60*60 ;
} else {
    $opt_s = $opt_s ? $opt_s : 212 ; 
    $LogPath = $opt_l ? $opt_l : 
    #"/home/logs/172.16.45.206/localhost_access_log.$thisDay.txt";
    "/home/kk/logs/172.16.45.212/LogFiles/W3SVC1/u_ex$thisDay.log";
}
...
sub help {
    ...
    参数：
            ...
            -l          log的路径，例如 /home/logs/172.16.45.212/localhost_access_log.2016-09-14.txt 
