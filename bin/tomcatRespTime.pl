...
#-------------------------------------------------------------------------------
my($T,$N) = tempfile("/tmp/tomcat-resp-$$-XXXX", "UNLINK", 0);
...
#`cp $N "/home/moqingqiang/tmp/$yesterday-resp.txt"` ;
#`cp "/tmp/tomcat-resp.png" "/home/moqingqiang/tmp/$yesterday-resp.png"` ;
