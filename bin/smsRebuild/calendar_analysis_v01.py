...
setDic = { 
            'calendar:addLabel':'添加日历',\
            'calendar:updateLabel':'更新日历',\
            'calendar:deleteLabel':'删除日历',\
            'calendar:getLabelById':'根据日历ID查询日历',\
            'calendar:subscribeLabel':'订阅公共日历',\
            'calendar:cancelSubscribeLabel':'取消订阅公共日历',\
            'calendar:getLabels':'查询用户日历列表',\
            'calendar:listTopLabels':'查询前十个公共日历',\
            'calendar:getCalendarListView':' 查询活动列表（时间轴）',\
            'calendar:getCalendarView':'查询用户活动列表',\
            'calendar:getCalendar':'查询用户某个活动',\
            'calendar:addCalendar':'添加活动',\
            'calendar:updateCalendar':'更新活动',\
            'calendar:deleteCalendar':'取消活动',\
            'api:getCalendarListView':'运营-查询活动列表视图',\
            'api:addCalendar':'运营-添加活动',\
            'api:updateCalendar':'运营-更新活动',\
            'api:getCalendar':'运营-查询某个活动',\
            'api:deleteCalendar':'运营-删除活动',\
            'api:subscribeLabel':'运营-订阅公共日历',\
            'calendar:searchPublicLabel':'搜索公共日历',\
            'calendar:getPublishedLabelByOper':'查询单个公共日历的详情（运营）',\
            'api:publishLabelByOper':'发布公共日历',\
            'api:updatePublishedLabelByOper':'修改公共日历',\
            'calendar:copyCalendar':'复制活动',\
            'calendar:getCalendarList':'查询活动列表（时间轴）',\
            'calendar:setCalendarRemind':'设置自定义提醒',\
            'calendar:shareCalendar':'活动分享接口',\
            'calendar:getCalendarsByLabel':'通过labelID获取所有活动详情',\
            'calendar:getHuangliData':'黄历查询接口',\
            'calendar:getMessageCount':'未读消息数量',\
            'calendar:getMessageList':'得到消息列表',\
            'calendar:getMessageById':'单个消息详情',\
            'calendar:delMessage':'删除消息',\
            ...
            'calendar:getCalendarViewWithInviter':'查询活动视图（可查出邀请人信息）',\
            'calendar:getDelCalendarSeqno':'sdk用的接口，用于得到增量删除的活动的ID',\
            'calendar:batchAddCalendar':'批量添加',\
            'calendar:batchAddCalForSDK':'批量添加 （SDK）',\
            'calendar:updateDragCalendar':'拖拽时修改活动',\
            'calendar:getBillData':'获取账单信息接口',\
            'calendar:addNoteCalendar':'添加邮件备注活动',\
            'calendar:delNoteCalendar':'删除邮件备注活动',\
            'calendar:importCalendarFile':'导入',\
            'calendar:exportCalendarFile':'导出',\
        }
