...
open my $fh_log1 , "/home/logs/1_mmlogs/crontabLog/http_resp_time.log"  || die $!;
open my $fh_log2 , "/home/logs/4_mmlogs/crontabLog/http_resp_time.log"  || die $!;
open my $fh_log3 , "/home/logs/3_mmlogs/crontabLog/http_resp_time.log"  || die $!;
open my $fh_log4 , "/home/logs/5_mmlogs/crontabLog/http_resp_time.log"  || die $!;
#
...
printflush $P qq[
        ...
        set title "All Tomcat Today response time" font "/usr/share/fonts/dejavu-lgc/DejaVuLGCSansMono-Bold.ttf, 20"
        set xdata time
        set timefmt "%H:%M"
        set format x "%H:%M"
        set grid
        ...
        set output "/tmp/tomcat-resp_now.png"
