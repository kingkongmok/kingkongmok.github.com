...
#===============================================================================
#
#         FILE: tomcatMethodSmall_now.pl
#
#        USAGE: ./tomcatMethodSmall_now.pl
#
#  DESCRIPTION: 
#
#      OPTIONS: ---
...
printflush $P qq[
        ...
        set title "All Tomcat Today Methods visited SmallView" font "/usr/share/fonts/dejavu-lgc/DejaVuLGCSansMono-Bold.ttf, 20"
        set xdata time
        set timefmt "%H:%M"
        set format x "%H:%M"
        set grid
